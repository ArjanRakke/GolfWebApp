...
public class BaanStatusResource {
	...
	public Response updateBaanStatus(/* @Context SecurityContext sc, */
			@PathParam("baan_id") int bId, @FormParam("open") String gbBes, @FormParam("greens") String zwg,
			@FormParam("trolleysEnGolfkarren") String trlsGfk, @FormParam("qualifying") String qual,
			@FormParam("bemest") String bem, @FormParam("onderhoud") String ond, @FormParam("aankondiging") String aan) {
